...
# The following code requires up to 40 GB of RAM over 2 hours if using 6 CPUs
...
pf.create_glass_rolling_plot("sa", 1983, 2019, "all", 5, "mlai", glass_source_pref="avhrr", output=True)
pf.create_glass_rolling_plot("sa", 1983, 2019, "all", 5, "mlai", glass_source_pref="modis", output=True)
...
cf.create_all_possible_diff_data_files("sa", "Jan-2003", "Dec-2007", "Jan-2016", "Dec-2020", "all")
cf.create_all_possible_diff_data_files("sa", "Jan-2003", "Dec-2007", "Jan-2016", "Dec-2020", [1, 2, 3, 4, 5, 6])
cf.create_all_possible_diff_data_files("sa", "Jan-2003", "Dec-2007", "Jan-2016", "Dec-2020", [7, 8, 9, 10, 11, 12])
