...
\title{The effect of land\\cover change on\\surface wind resource}  % use \\ here otherwise you get a justified title
                                     % note capitalization of the title (only common 
                                     % words in lower case)
\tagline{and its implications for wind energy generation}      % tag line
