\chapter{Supplementary information, tables and graphs}
\label{app:supp}
...
\begin{landscape}
	...
	\begin{longtable}{P{2cm}P{3cm}P{15cm}}
		\caption[Full list of study variables]{Variables which were analysed. Abbreviations for these variables as used in this report are provided, along with descriptions of each variable.} 
