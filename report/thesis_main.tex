...
\title{The effect of land\\cover change on\\surface wind resource\\in southwest\\Western Australia}  % use \\ here otherwise you get a justified title
                                     % note capitalization of the title (only common 
                                     % words in lower case)
\tagline{and implications for wind energy generation}      % tag line
...
\degreeName{Master of Engineering Science in Renewable Energy Engineering}       % the degree you are reading
...
%%	\part{Your First Part} %% PhDs may require this parts idea as well.
    ...
    \input{chap2/literature_review_main}
